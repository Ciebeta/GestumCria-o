...
import { CalendarioView } from "./aluno/CalendarioView";
import { FeedbacksView } from "./aluno/FeedbacksView";
import { PropostasView } from "./aluno/PropostasView";
import { DenunciasView } from "./aluno/DenunciasView";
...
export const AlunoLayout = ({ profile }: AlunoLayoutProps) => {
